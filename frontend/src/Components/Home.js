  ...
  return (
    <div className={classes.root}>
      ...
      <Toolbar className={classes.toolbar}>
          ...
          <Button variant="outlined" className={classes.loginButton} onClick={handleLoginClick}>
            Login
          </Button>
          <Button variant="outlined" className={classes.signUpButton} onClick={handleRegisterClick}>
            Sign up
          </Button>
        </Toolbar>
      </AppBar>
      <div className={classes.background}>
        <img src={homepage} className={classes.img}/>
